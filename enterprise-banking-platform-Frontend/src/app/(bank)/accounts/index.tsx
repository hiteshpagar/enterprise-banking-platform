...
import type { AccountPage, AccountSummary } from "../../../types/account";
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.headerRow}>
          ...
          <View style={styles.headerCopy}>
            <Text style={styles.eyebrow}>Bank Accounts</Text>
        ...
        <View style={styles.searchRow}>
          ...
          <Pressable onPress={handleSubmitSearch} style={styles.searchButton}>
      ...
      <AccountList
        ...
        onAccountPress={(id) => router.push(`/(bank)/accounts/${id}` as Href)}
